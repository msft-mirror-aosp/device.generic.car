...
#define PROPERTY_UWB_SERVICE   "vendor.qemu.preferred.uwb.service"   // The preferred UWB service name
#define PROPERTY_UWB_SERVICE_GOLDFISH   "goldfish"   // The supported service name for PROPERTY_UWB_SERVICE
#define PROPERTY_UWB_SERVICE_IP   "vendor.qemu.preferred.uwb.service.ip"   // The IP of the UWB simulation server
#define PROPERTY_UWB_SERVICE_PORT "vendor.qemu.preferred.uwb.service.port" // The port of the UWB simulation server
